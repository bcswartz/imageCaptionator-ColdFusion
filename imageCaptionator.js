...
var submitOptions = {
        target:        '#resultImage',   // target element(s) to be updated with server response
...
$(document).ready(function() {
	...
	$('.colorBlock').resizable({autohide: true, handles: 'all'});
	...
	$("#buttonAddText").click(function() {
		...
		$("#" + newBlockId).attr("style","left:" + imagePos.left + "px;top:" + imagePos.top + "px;position:absolute;color:#ffffff;background-color:transparent;border:1px dotted white;font-style:normal;font-weight:normal;font-family:Arial;font-size:16px;text-decoration:none;z-index:" + $("#blockCount").val() + ";");
	...
	$("#fontSize").change(function () {
		var blockId= $("#blockId").val();
		$("#" + blockId).css("font-size",$("#fontSize").val());
	});
